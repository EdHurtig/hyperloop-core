...
#define LP_TRANSDUCER_CALIBRATION_B 0.064
#define LP_TRANSDUCER_CALIBRATION_C 0.694

// #define HP_TRANSDUCER_CALIBRATION_A 0.0
// #define HP_TRANSDUCER_CALIBRATION_B 1.0
// #define HP_TRANSDUCER_CALIBRATION_C 0.0

#define HP_TRANSDUCER_CALIBRATION_A 0.0
#define HP_TRANSDUCER_CALIBRATION_B 0.6593
#define HP_TRANSDUCER_CALIBRATION_C -170

#define WHITE_THERMO_CALIBRATION_A 0.0002
#define WHITE_THERMO_CALIBRATION_B 0.0727
#define WHITE_THERMO_CALIBRATION_C -96.693
