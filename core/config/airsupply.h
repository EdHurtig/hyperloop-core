...
#define NOMINAL_MINI_TANK_PSIA 35
...
#define _LP_PRESSURE_ERR 2

#define LP_TRANSDUCER_CALIBRATION_A 0.0
#define LP_TRANSDUCER_CALIBRATION_B 0.0
#define LP_TRANSDUCER_CALIBRATION_C 0.064
#define LP_TRANSDUCER_CALIBRATION_D -13.306 // 0.694

#define LP_TRANSDUCER_CALIBRATION_A 0.0
#define HP_TRANSDUCER_CALIBRATION_B 0.0
#define HP_TRANSDUCER_CALIBRATION_C 0.745009
#define HP_TRANSDUCER_CALIBRATION_D -170

#define WHITE_THERMO_CALIBRATION_A 0.0
#define WHITE_THERMO_CALIBRATION_B 0.0
#define WHITE_THERMO_CALIBRATION_C 0.35165
#define WHITE_THERMO_CALIBRATION_D -124.2

#define CLAMP_THERMO_CALIBRATION_A 0.0
#define CLAMP_THERMO_CALIBRATION_B 0.0
#define CLAMP_THERMO_CALIBRATION_C 0.35165
#define CLAMP_THERMO_CALIBRATION_D -124.2

#define FLOW_THERMO_CALIBRATION_A 0.0
#define FLOW_THERMO_CALIBRATION_B 0.0001251492
#define FLOW_THERMO_CALIBRATION_C -0.4291051844
#define FLOW_THERMO_CALIBRATION_D 267.968699
...
#define REG_SURF_THERMO_MUX THERMO_MUX_0
...
#define CLAMP_PAD_THERMO_MUX THERMO_MUX_0
